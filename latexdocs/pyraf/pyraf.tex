...
Ensure you have activated the {\tt conda} environment that you set up in the {\bf Computer Setup} section. Create a {\tt login.cl} file to configure IRAF by running {\tt mkiraf} in your home directory. Hit enter to accept the default options when prompted.
