...
GH_PAGES_EXCLUDE = build _sources _static _downloads _images latexdocs python apt_etc spectroscopy downloads
...
qthelp:
	...
	@echo "# qcollectiongenerator $(BUILDDIR)/qthelp/RIATraining.qhcp"
	@echo "To view the help file:"
	@echo "# assistant -collectionFile $(BUILDDIR)/qthelp/RIATraining.qhc"
...
devhelp:
	...
	@echo "Build finished."
	@echo "To view the help file:"
	@echo "# mkdir -p $$HOME/.local/share/devhelp/RIATraining"
	@echo "# ln -s $(BUILDDIR)/devhelp $$HOME/.local/share/devhelp/RIATraining"
	@echo "# devhelp"
