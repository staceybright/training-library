# -*- coding: utf-8 -*-
#
# RIA Training documentation build configuration file, created by
# sphinx-quickstart on Tue Oct 28 22:51:10 2014.
#
...
copyright = (u'{}, AURA / Space Telescope Science Institute. These documents '
    ...
    'contradict published documentation. Use at your own risk')
# note: the final period after 'use at your own risk'
# is part of the template

# fill in copyright year
import datetime
today = datetime.date.today()
copyright = copyright.format(today.year)
...
version = 'published {}-{}-{}'.format(today.year, today.month, today.day)
...
html_title = 'RIA Training Library (v{})'.format(release)
...
htmlhelp_basename = 'RIATrainingdoc'
